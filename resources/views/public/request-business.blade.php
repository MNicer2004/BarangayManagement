@extends('layouts.app')
@section('title','Barangay Business Permit')
        ...
        <div class="card-glass side-card h-100">
          ...
          <div class="p-3 p-md-4 side-card__meta">
            <div class="d-flex align-items-center mb-2">
              ...
              <div class="fw-semibold">Fees: <span class="text-white">Varies</span></div>
            </div>
          ...
          <div class="px-3 px-md-4 pt-3">
            ...
            <div class="item-check">
              ...
              <span>Valid ID of owner/proprietor</span>
            </div>
            <div class="item-check">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7FA7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Business name registration (DTI/SEC/Coop) – photocopy</span>
            </div>
            <div class="item-check">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7FA7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Proof of business address (lease contract or proof of ownership)</span>
            </div>
            <div class="item-check">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7FA7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Sketch/photo of business location or storefront</span>
            </div>
            <div class="item-check">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7FA7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Community Tax Certificate (CTC) for business (if applicable)</span>
            </div>
            <div class="text-ink-300 small mt-2">
              * Additional permits may be required by the municipality/city (e.g., sanitary, fire safety).
            </div>
          </div>
          ...
          <div class="px-3 px-md-4 py-3">
            ...
            <div class="item-check">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7FA7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Processing may include <strong>on-site verification/inspection</strong> if needed.</span>
            </div>
            <div class="item-check">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7FA7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
              <span>Bring photocopies and originals of documents upon pickup at the <strong>Barangay Hall</strong>.</span>
            </div>
            <div class="item-check">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7FA7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
      ...
      <div class="col-12 col-lg-8">
        <div class="card-glass form-shell">
          <div class="border-bottom border-white border-opacity-25 px-3 px-md-4 py-3">
            <h2 class="h5 m-0 fw-bold text-uppercase">Barangay Business Permit</h2>
          </div>

          <form id="businessForm" class="p-3 p-md-4">
            <div class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12">
                <label class="form-label fw-semibold">Business/Complete Address</label>
                <input id="address" type="text" class="form-control" placeholder="Building/No., Street, Barangay, Town/City" required>
              </div>
            </div>
            ...
            <div class="mt-3">
              <label class="form-label fw-semibold">Purpose / Nature of Business</label>
              <textarea id="purpose" class="form-control" rows="3" placeholder="Enter purpose (e.g., New permit, Renewal; Nature: Sari-sari store, Services, etc.)" required></textarea>
            </div>
    ...
    <div class="modal-content" style="background:#0A1832;color:#F6FAFD;border:1px solid rgba(255,255,255,.2)">
      ...
      <div class="modal-body pt-0">
        ...
        <div class="d-flex align-items-center gap-2 mb-3">
          <code id="previewCode" class="fs-5 fw-bold">BPER-0000-XXXXX</code>
          <button id="copyCode" type="button" class="btn btn-sm btn-outline-light">Copy</button>
        </div>
        <div class="small text-ink-300 mb-3">
          Bring your documents and ID. Pick-up date: <span id="previewPickup" class="text-white fw-semibold">—</span>.
        </div>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('businessForm').addEventListener('submit', e => {
      e.preventDefault();
      const code = `BPER-${new Date().getFullYear()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`;
